...
export default function FeePlansPage() {
    ...
    const fetchHeads = async () => {
        try {
            const r = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://school-sbis.onrender.com"}` + '/fee-heads/active');
    ...
    const fetchClasses = async () => {
        try {
            const r = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://school-sbis.onrender.com"}` + '/academic');
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const url = editMode ? `${process.env.NEXT_PUBLIC_API_URL || "https://school-sbis.onrender.com"}/fee-plans/${editId}` : `${process.env.NEXT_PUBLIC_API_URL || "https://school-sbis.onrender.com"}` + '/fee-plans';
    ...
    const handleDelete = async (id: number) => {
        ...
        await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://school-sbis.onrender.com"}/fee-plans/${id}`, { method: 'DELETE' });
        fetchPlans();
    };
