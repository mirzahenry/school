...
export default function SectionSettings() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const url = editMode ? `${process.env.NEXT_PUBLIC_API_URL || "https://school-sbis.onrender.com"}/academic/sections/${selectedId}` : `${process.env.NEXT_PUBLIC_API_URL || "https://school-sbis.onrender.com"}` + '/academic/sections';
    ...
    const handleDelete = async (id: number) => {
        ...
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://school-sbis.onrender.com"}/academic/sections/${id}`, { method: 'DELETE' });
            if (res.ok) {
                fetchSections();
