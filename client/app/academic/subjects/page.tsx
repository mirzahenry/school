...
export default function SubjectSettings() {
    ...
    const fetchClasses = async () => {
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://school-sbis.onrender.com"}` + '/academic');
    ...
    const fetchSections = async () => {
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://school-sbis.onrender.com"}` + '/academic/sections');
    ...
    const fetchSubjects = async () => {
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://school-sbis.onrender.com"}` + '/academic/subjects');
    ...
    const handleDelete = async (id: number) => {
        ...
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://school-sbis.onrender.com"}/academic/subjects/${id}`, { method: 'DELETE' });
            if (res.ok) {
                fetchSubjects();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const url = editMode
            ? `${process.env.NEXT_PUBLIC_API_URL || "https://school-sbis.onrender.com"}/academic/subjects/${selectedId}`
            : `${process.env.NEXT_PUBLIC_API_URL || "https://school-sbis.onrender.com"}` + '/academic/subjects';
