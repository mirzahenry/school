...
export default function StudentPromotion() {
    ...
    const fetchPromotionReadyYears = async () => {
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://school-sbis.onrender.com"}` + '/academic/years/promotion-ready');
            if (res.ok) {
    ...
    const fetchClasses = async () => {
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://school-sbis.onrender.com"}` + '/academic/classes');
            if (res.ok) {
                const data = await res.json();
    ...
    const loadStudents = async () => {
        ...
        try {
            ...
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://school-sbis.onrender.com"}/promotion/load-students?${params}`);
            if (!res.ok) {
    ...
    const executePromotion = async () => {
        ...
        try {
            ...
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://school-sbis.onrender.com"}` + '/promotion/execute', {
                method: 'POST',
