...
export default function FamilyFeeReportPage() {
    ...
    useEffect(() => {
        ...
        fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://school-sbis.onrender.com"}` + '/reports/fee-heads').then(r => r.json()).then(setFeeHeads).catch(console.error);
    }, []);
    ...
    const loadReport = async () => {
        ...
        try {
            ...
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://school-sbis.onrender.com"}/reports/family-fee?${params}`);
