    ...
    const fetchStudentData = async () => {
        try {
            ...
            if (res.ok) {
                ...
                if (data.family_id) {
                    try {
                        const fRes = await fetch(`${process.env.NEXT_PUBLIC_API_URL || "https://school-sbis.onrender.com"}/students/families/${data.family_id}`);
                        if (fRes.ok) {
                                    ...
                                    <div className="col-md-2 text-center">
                                        <div className="border border-2 border-dashed rounded-3 d-flex align-items-center justify-content-center bg-light position-relative"
                                            ...
                                            {imageFile ? (
                                                ...
                                                <img src={`${process.env.NEXT_PUBLIC_API_URL || "https://school-sbis.onrender.com"}/${existingImage}`} alt="Current"
                                                    style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                            ) : (
